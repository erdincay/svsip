/* $Id: pjsua_acc.c 2194 2008-08-05 20:14:39Z bennylp $ */
/* 
...
#if defined(PJ_NDS) && PJ_NDS!=0 // bug in newlib of devkitpro r20
    if (acc->display.slen == 0)
